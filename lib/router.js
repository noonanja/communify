...
ListingPageController = RouteController.extend({
  ...
  findOptions: function() {
    ...
    return {sort: this.sort, category: t, limit: this.limit()}; 
  },
  waitOn: function() {
    return Meteor.subscribe("posts", this.findOptions());
  },
  data: function() {
    return Listings.findOne({titleURL: this.params.titleURL})
  }
});
...
if (Meteor.isClient) {
  ...
  Router.onAfterAction(closeOverlay, {except: 'search'});
}
